        ...
        <div class="col-md-9">
            <form action="<?php echo base_url('/TX/quicktrade') ?>" method="post" accept-charset="utf-8">
                <div class="form-group">
                    ...
                    <div class="radio">
                        <label>
                            <input type="radio" name="operation" disabled id="buy" value="buy" checked onclick="selectOperation()">Buy</label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="operation" disabled id="sell" value="sell" onclick="selectOperation()">Sell</label>
                    </div>
                    <div class="dropdown">
                    ...
                    <button type="button" class="btn btn-yellow" disabled onclick="setAmountFactor('max')">MAX</button>
                    <br>
